...
ExpressInstall.prototype = {
    ...
    onInstallStatus: function(msg):Void {
        if (msg == "Download.Complete") {
            ...
            // feel free to change this to whatever you want, js errors are sufficient for this example
            getURL("javascript:alert('There was an error downloading the Flash Player update. Please try again later, or visit www.macromedia.com to download the latest version of the Flash plugin.')");
        }
    }
}
